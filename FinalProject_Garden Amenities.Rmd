...
gardeninfo = read_csv("P8105 Data Science I/finalproject/GreenThumb_Garden_Info_20241127.csv") %>% janitor::clean_names()
gardenamenities = read_csv("P8105 Data Science I/finalproject/GreenThumb_Site_Visits_20241127.csv") %>% janitor::clean_names()
...
income = read_csv("P8105 Data Science I/finalproject/censusincome2024.csv") %>% janitor::clean_names()
