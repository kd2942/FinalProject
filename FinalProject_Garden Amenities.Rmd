...
gardeninfo = read_csv("./GreenThumb_Garden_Info_20241127.csv") %>% janitor::clean_names()
gardenamenities = read_csv("./GreenThumb_Site_Visits_20241127.csv") %>% janitor::clean_names()
